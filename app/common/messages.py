class Messages:
    ...
    torrent_is_invalid = 'В торренте нет файлов, которые были бы меньше максимального размера в 2 Гб (это временное ограничение). Выберите другой торрент для закачки.'
