...
error_messages = {
    "1": "Чтобы мой помощник @torrentsready смог отправить файлы, он должен получить от тебя разрешение. \
        Пошли ему любое сообщение, затем подтверди здесь, нажав кнопку ниже:",
